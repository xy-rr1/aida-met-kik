...
const faqData = [
    ...
    {
        keywords: ['stesen cuaca', 'stesen meteorologi', 'lokasi stesen', 'senarai stesen', 'stesen malaysia', 'stesen di', 'stesen dekat'],
...
app.post("/chat", async (req, res) => {
    ...
    try {
        ...
        if (lang === 'EN') {
            ...
            1. Answer directly, professionally, politely, and provide a COMPLETE and IN-DEPTH response structure.
            2. THE RESPONSE FORMAT MUST CONTAIN:
               - Paragraph 1: A clear scientific definition or technical description of the topic.
            ...
            3. It is STRICTLY FORBIDDEN to mention the words "JSON", "database", "provided file", or "information from JSON" in your response. Act as if you naturally know all this information.
            4. LANGUAGE RULE: You MUST reply 100% in ENGLISH. Do not mix languages or use Malay words.
            5. If the user's question is unrelated to MET Malaysia's scope or meteorology, politely state that you are only trained for the department's scope.`;
        } else {
            ...
            1. Jawab secara terus, profesional, mesra, dan berikan struktur jawapan yang LENGKAP serta MENDALAM.
            2. FORMAT JAWAPAN WAJIB MENGANDUNGI:
               - Perenggan 1: Definisi saintifik atau huraian teknikal topik secara jelas.
            ...
            3. HARAM dan DILARANG SAMA SEKALI menyebut perkataan "JSON", "pangkalan data", "fail yang diberikan", atau "maklumat dari JSON" dalam jawapan anda. Berlakon seolah-olah anda memang sudah tahu semua maklumat ini secara semula jadi.
            4. PERATURAN BAHASA: Anda WAJIB menjawab 100% dalam BAHASA MALAYSIA yang profesional tanpa bercampur bahasa.
            5. Sekiranya soalan pengguna tidak berkaitan dengan skop MET Malaysia atau meteorologi, jawab dengan sopan bahawa anda hanya dilatih untuk skop jabatan sahaja.`;
        }
